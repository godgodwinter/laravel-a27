<div class="page-body">
    <div class="row">
        ...
        @if(!empty($ambilsupplierterpilih['id']))
        @php($id_pelanggan=$ambilsupplierterpilih['id'])
        @else 
        @php($id_pelanggan=0)
        @endif
                ...
                <div class="card-block">
                    <div class="row m-b-30">
                        <div class="col">
                            ...
                            <input type="text" wire:model="caribarang" id="caribarang" placeholder="Cari Barang... "
                            ...
                            <button wire:click="checkout( {{$id_pelanggan}},{{$total}},{{$pembayarantunai}},{{$diskon}},{{$total_bayar}},{{$kembalian}},{{$harga_diskon}})" class="btn btn-success mt-2">Checkout</button>
                            @else

                            <button type="button" class="btn btn-secondary mt-2" data-toggle="tooltip" data-placement="bottom"
                                title="Uang Pembayaran kurang dari Total Biaya dan Pilih Pelanggan dahulu">
                                Checkout
                            </button>
    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-md-4">
            <div class="card">
                ...
                <div class="card-block-big"> <input type="text" wire:model="search" placeholder="Cari Pelanggan... "
                        class="form-control mt-1">
                    <div class="card-block">
                        {{-- {{dd($Supplierterpilih)}} --}}
                        ...
                        <div class="row m-b-30">
                            ...
                            <div class="col">
                                ...
                                <h6 class="m-b-5">Nama Supplier :
                                    @if (isset($ambilsupplierterpilih['name'])===true)
                                    {{$ambilsupplierterpilih['name']}}
                                    @else
                                    Belum dipilih
                                    @endif</h6>
                            </div>
                        ...
                        <div class="row m-b-30">
                            ...
                            <button wire:click="clearTerpilih" class="btn btn-warning"><span class="pcoded-micon"> <i
                                        class="feather icon-primary"></i>Pilih Pelanggan
                                    lagi?</button>
                            @else
                ...
                <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                    ...
                    <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$customer->name}}</td>
                                        <td>
                                            <button wire:click="addToPilih({{$customer->id}})"
                                                class="btn btn-success"><span class="pcoded-micon"> <i
                                                        class="feather icon-edit"></i>Pilih</button>
                                        </td>
                                    </tr>
