...
<div class="page-body">
            ...
            <div class="table-responsive dt-responsive">
                <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ ($loop->index)+1 }} </td>
                            <td>{{$product_unit->nama}}</td>
                            <td>{{$product_unit->kepanjangan}}</td>
                            <td>
                                <a class="btn btn-warning btn-outline-warning"
                                    href="/product_units/{{$product_unit->id}}/edit"><span class="pcoded-micon"> <i
                                            class="feather icon-edit"></i></span></a>
                                <form action="/product_units/{{$product_unit->id}}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
    ...
    <div class="card">
        <div class="card-block">
            <div class="card-body">
                <form action="/product_units" method="post">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-nama">Nama Satuan Produk (*</label>
                                    <input type="text" name="nama" id="input-nama"
                                        class="form-control form-control-alternative  @error('nama') is-invalid @enderror"
                                        placeholder="Contoh : Cm " value="{{old('nama')}}" required>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-nama">Nama Panjang Satuan (*</label>
                                    <input type="text" name="kepanjangan" id="input-nama"
                                        class="form-control form-control-alternative  @error('kepanjangan') is-invalid @enderror"
                                        placeholder="Contoh : Centi meter " value="{{old('kepanjangan')}}" required>
