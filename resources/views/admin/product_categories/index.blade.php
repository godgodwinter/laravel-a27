            ...
            <div class="table-responsive dt-responsive">
                <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ ($loop->index)+1 }} </td>
                            <td>{{$product_category->nama}}</td>
                            <td>
                                <a class="btn btn-warning btn-outline-warning"
                                    href="/product_categories/{{$product_category->id}}/edit"><span class="pcoded-micon"> <i
                                            class="feather icon-edit"></i></span></a>
                                <form action="/product_categories/{{$product_category->id}}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-nama">Nama Kategori Produk (*</label>
