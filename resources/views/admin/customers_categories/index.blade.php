...
<div class="page-body">
        ...
        <div class="card-block">
            <div class="table-responsive dt-responsive">
                <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                    ...
                    <tbody>
                        @foreach ($customers_categories as $costumers_category)


                        <tr>
                            <td>{{ ($loop->index)+1 }} </td>
                            <td>{{$costumers_category->nama}}</td>
                            <td>
                                <a class="btn btn-warning btn-outline-warning"
                                    href="/customers_categories/{{$costumers_category->id}}/edit"><span class="pcoded-micon"> <i
                                            class="feather icon-edit"></i></span></a>
                                <form action="/customers_categories/{{$costumers_category->id}}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
    ...
    <div class="card">
        <div class="card-block">
            <div class="card-body">
                <form action="/customers_categories " method="post">
                    @csrf
                    <h5>Tambah Kategori Pelanggan</h5>
                    <span>&nbsp; </span>
                    <div class="pl-lg-4">
                        <div class="row">
                            <div class="col-lg-6">
